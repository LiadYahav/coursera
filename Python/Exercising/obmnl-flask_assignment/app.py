...
# adding search option to search transactions between certain amounts
...
# adding option to check total balance
@app.route("/balance")
def total_balance():
    total = sum(transaction['amount'] for transaction in transactions)
    return render_template('transactions_total_balance.html', transactions=transactions, total_balance=total)
